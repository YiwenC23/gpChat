...
def get_embedding(
    ...
    **kwargs
    ...
    Args:
        ...
        embedding_dimension: Dimension of the embedding (default 768 for Ollama)
    ...
    # Use the provided embedding_dimension parameter, but allow model-specific overrides
    # only if embedding_dimension is not explicitly set
    if embedding_dimension == 768:  # Default for Ollama
